...
retry | - | Mobile robot is restarting the action defined via actionId. | - | The referenced action has left state 'RETRIABLE' and is executed again. The result is reported in the actionState of the referenced action. | The action could not be retried, e.g., because no action with this actionId exists or the action is not in state 'RETRIABLE'. | -
skipRetry | - | - | - | The action referenced via the actionId has been set to 'FAILED'. | The action could not be skipped, e.g., because no action with this actionId exists or the action is not in state 'RETRIABLE'. | -
