...
[7 Protocol specification](#7-protocol-specification)<br>
  [7.1 Symbols of the tables and meaning of formatting](#71-symbols-of-the-tables-and-meaning-of-formatting)<br>
    [7.1.1 Optional fields](#711-optional-fields)<br>
    [7.1.2 Permitted characters and field lengths](#712-permitted-characters-and-field-lengths)<br>
    [7.1.3 Notation of fields, topics and enumerations](#713-notation-of-fields-topics-and-enumerations) <br>
    [7.1.4 JSON data types](#714-json-data-types)<br>
  [7.4 Protocol header](#74-protocol-header)<br>
  [7.5 Topics for communication](#75-topics-for-communication)<br>
  [7.6 Topic: "order" (from master control to AGV)](#76-topic-order-from-master-control-to-agv)<br>
    [7.6.1 Concept and logic](#761-concept-and-logic)<br>
    [7.6.2 Orders and order updates](#762-orders-and-order-update)<br>
    [7.6.3 Order cancellation (by master control)](#763-order-cancellation-by-master-control)<br>
    [7.6.4 Order rejection](#764-order-rejection)<br>
    [7.6.5 Corridors](#765-corridors)<br>
    [7.6.6 Implementation of the order message](#766-implementation-of-the-order-message)<br>
  [7.7 Maps](#77-maps)<br>
    [7.7.1 Map distribution](#771-map-distribution)<br>
    [7.7.2 Maps in vehicle state](#772-maps-in-the-vehicle-state)<br>
    [7.7.3 Map download](#773-map-download)<br>
    [7.7.4 Enable downloaded maps](#774-enable-downloaded-maps)<br>
    [7.7.5 Delete maps on vehicle](#775-delete-maps-on-vehicle)<br>
  [7.8 Sharing of planned path for freely-navigating mobile robots](#78-sharing-of-planned-path-for-freely-navigating-mobile-robots)<br>
  [7.9 Zones](#79-zones)<br>
    [7.9.1 Zone types](#791-zone-types)<br>
    [7.9.2 Implementation of the zone set transfer](#792-implementation-of-the-zone-set-transfer)<br>
    [7.9.3 Communication for interactive zones](#793-communication-for-interactive-zones)<br>
    [7.9.4 Interaction between zones](#794-interactions-between-zones)<br>
    [7.9.4 Error handling within zones](#795-error-handling-within-zones)<br>
  [7.10 Actions](#710-actions)<br>
    [7.10.1 Definition, parameters, effects and scope of predefined actions](#7101-definition-parameters-effects-and-scope-of-predefined-actions)<br>
    [7.10.2 States of predefined actions](#7102-states-of-predefined-actions)<br>
  [7.11 Topic: "instantActions" (from master control to AGV)](#711-topic-instantactions-from-master-control-to-agv)<br>
  [7.12 Topic: "state" (from AGV to master control)](#712-topic-state-from-agv-to-master-control)<br>
    [7.12.1 Concept and logic](#7121-concept-and-logic)<br>
    [7.12.2 Traversal of nodes and entering/leaving edges, triggering of actions](#7122-traversal-of-nodes-and-enteringleaving-edges-triggering-of-actions)<br>
    [7.12.3 Base request](#7123-base-request)<br>
    [7.12.4 Request use of Corridors](#7124-request-use-of-corridors)<br>
    [7.12.4 Information](#7124-information)<br>
    [7.12.5 Errors](#7125-errors)<br>
    [7.12.6 Operating Mode](#7126-operating-mode)<br>
    [7.12.7 Implementation of the state message](#7127-implementation-of-the-state-message)<br>
  [7.13 actionStates](#713-action-states)<br>
  [7.14 Action blocking types and sequence](#714-action-blocking-types-and-sequence)<br>
  [7.15 Topic "visualization"](#715-topic-visualization)<br>
  [7.16 Topic "connection"](#716-topic-connection)<br>
  [7.17 Topic "response"](#717-topic-response)<br>
  [7.18 Topic "factsheet"](#718-topic-factsheet)<br>
    [7.18.1 Factsheet JSON structure](#7181-factsheet-json-structure)<br>
[8 Best practice](#8-best-practice)<br>
  [8.1 Error reference](#81-error-reference)<br>
  [8.2 Format of parameters](#82-format-of-parameters)<br>
...
The AGV shall communicate this information via the topic `factsheet` in a specific way that is defined in Section [7.18 Topic "Factsheet"](#718-topic-factsheet) of this document.
...
The use of this feature is described in Section [7.16 Topic "connection"](#716-topic-connection).
...
topic | string | Topic (e.g., order or state) see Section [7.5 Topics for Communication](#75-topics-for-communication)
...
# 7 Protocol Concepts and Logic

# 7.1 Order

Order is the main message sent by master control to command a mobile robot.

### 7.1.1 Concept and logic
...
4) **is start of new order close enough to current position?**:	Is the vehicle already standing on the node, or is it in the node's deviation range (see Section [7.6.1 Concept and logic](#761-concept-and-logic))?
...
### 7.1.3 Idle state of the mobile robot
...
### 7.1.4 Reporting of horizon actions in the mobile robot's state
...
### 7.4.3 Order cancellation (by master control)
...
#### 7.1.3.1 Receiving a new order after cancellation
...
#### 7.1.3.2 Receiving a cancelOrder action when AGV is idle
...
### 7.1.4 Order rejection

There are several scenarios, when an order shall be rejected.
These scenarios are shown in Figure 8 and described below.


#### 7.1.4.1 Vehicle gets a malformed new order
...
#### 7.1.4.2 Vehicle receives an order with actions it cannot perform or with fields that it cannot use
...
#### 7.1.4.3 Vehicle gets a new order with the same orderId, but a lower orderUpdateId than the current orderUpdateId
...
- The vehicle is changing the operating mode to 'MANUAL', 'SERVICE' or 'TEACHIN' (see also [7.10.6 Implementation of the state message](#7106-implementation-of-the-state-message)).
...
See also Section [7.12.2 Traversal of nodes and entering/leaving edges](#7122-traversal-of-nodes-and-enteringleaving-edges-triggering-of-actions) for further information.
...
#### 7.2.2 Maps in the vehicle state
...
## 7.3 Sharing of planned path for freely navigating mobile robots
...
Potential conflicts in orders due to overlapping of zones or combination of zone and edge properties and how to resolve them are addressed in section [7.9.4](#794-interactions-between-zones) .
...
#### 7.4.1.2 Kinematic center-based zones
...
## 7.4.3 Communication for interactive zones 
...
### 7.4.4 Interactions between zones
...
### 7.4.5 Error handling within zones
...
If the AGV supports actions other than driving, these actions are executed via the action field that is attached to either a node or an edge, or sent via the separate topic `instantActions` (see Section [7.10 Topic "instantActions"](#710-topic-instantactions-from-master-control-to-agv)).

Actions that are to be executed on an edge shall only run while the AGV is on the edge (see Section [7.12.2 Traversal of nodes and entering/leaving edges](#7122-traversal-of-nodes-and-enteringleaving-edges-triggering-of-actions)).
...
## 7.5.1 Action blocking types and sequence
...
### 7.5.2 Definition, parameters, effects and scope of predefined actions
...
### 7.5.4 States of predefined actions
...
### 7.5.5 Update vehicle certificate
...
### 7.6.2 Traversal of nodes and entering/leaving edges, triggering of actions
...
### 7.6.4 Request use of Corridors
...
### 8.1.1 Symbols of the tables and meaning of formatting
...
### 8.1.3 Permitted characters and field lengths
...
For ease of integration, AGV vendors shall supply an AGV factsheet that is detailed in [Factsheet Section](#716-topic-factsheet).


### 8.1.4 Notation of fields, topics and enumerations
...
## 8.2.1 Topic "order" (from master control to AGV)
...
*allowedDeviationXY* | m | JSON<br>object | Indicates how precisely a vehicle shall match the position of a node for it to be considered traversed.<br>(see also [7.6.3 Order cancellation (by master control)](#763-order-cancellation-by-master-control) and [7.10.2 Traversal of nodes and entering/leaving edges, triggering of actions](#7102-traversal-of-nodes-and-enteringleaving-edges-triggering-of-actions)).
*allowedDeviationTheta* | rad | float64 | Range: [0.0 ... Pi] <br><br>If defined, indicates how precisely a vehicle shall match the orientation of a node for it to be considered traversed.<br>(see also [7.6.3 Order cancellation (by master control)](#763-order-cancellation-by-master-control) and [7.10.2 Traversal of nodes and entering/leaving edges, triggering of actions](#7102-traversal-of-nodes-and-enteringleaving-edges-triggering-of-actions)).<br>The lowest acceptable angle is *`theta` - `allowedDeviationTheta`* and the highest acceptable angle is *`theta` + `allowedDeviationTheta`*. If `theta` is not specified no requirement exists for the vehicle orientation.<br>If = 0.0: no deviation is allowed, which means the vehicle shall reach the node orientation as precisely as is technically possible for the vehicle. This applies also if `allowedDeviationTheta` is smaller than the technical tolerance of the vehicle. If the vehicle supports this attribute, but it is not defined for this node by Master Control the vehicle shall assume this value as 0.0.
...
## 8.2.2 Topic "instantActions" (from master control to AGV)
...
### 8.2.3 Topic "zoneSet" (from master control to AGV) 

Implementation of the zone set transfer
...
| zoneType | string | Enum {'BLOCKED', 'LINE_GUIDED', 'RELEASE', 'COORDINATED_REPLANNING', 'SPEED_LIMIT', 'ACTION', 'PRIORITY', 'PENALTY', 'DIRECTED', 'BIDIRECTED'}, Zone type according to section [7.9.1 Zone types](#791-zone-types). |
...
| maxSpeed | float64 | Required only for SPEED_LIMIT zone as defined in chapter [7.9.1 Zone types](#791-zone-types).| 
| **entryActions[Action]**| array | Required only for ACTION zone as defined in chapter [7.9.1 Zone types](#791-zone-types).| 
| **duringActions[Action]** | array | Required only for ACTION zone as defined in chapter [7.9.1 Zone types](#791-zone-types).| 
| **exitActions[Action]** | array | Required only for ACTION zone as defined in chapter [7.9.1 Zone types](#791-zone-types).| 
| *releaseLossBehavior* | string | Optional only for RELEASE zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
| priorityFactor | float64 | Required only for PRIORITY zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
| penaltyFactor | float64 | Required only for PENALTY zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
| direction | float64 | Required only for DIRECTED and BIDIRECTED zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
| directedLimitation | string | Required only for a DIRECTED zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
| bidirectedLimitation | string | Required only for a BIDIRECTED zone as defined in chapter [7.9.1 Zone types](#791-zone-types).|
...
### 8.2.4 Topic "response" (from master control to AGV) 
...
## 8.2.6 Topic "state" (from AGV to master control)
...
operatingMode | | string | Enum {'STARTUP', 'AUTOMATIC', 'SEMIAUTOMATIC', 'INTERVENED', 'MANUAL', 'SERVICE', 'TEACHIN'}<br>For additional information, see Table in Section [7.12.6 Operating Mode](#7126-operating mode).
...
*nodeDescription* | | string | Additional information on the node.
released| | boolean | "true" indicates that the node is part of the base.<br>"false" indicates that the node is part of the horizon.
***nodePosition***<br><br>}| | JSON object | Node position. <br>The object is defined in Section [7.6 Topic "order"](#76-topic-order-from-master-control-to-agv) <br>Optional: <br>Master control has this information. <br>Can be sent additionally, e.g., for debugging purposes.
...
*edgeDescription* | | string | Additional information on the edge.
released | | boolean | "true" indicates that the edge is part of the base.<br>"false" indicates that the edge is part of the horizon.
***trajectory*** <br><br>} | | JSON object | The trajectory is to be communicated as NURBS and is defined in Section [7.6.6 Implementation of the order message](#766-implementation-of-the-order-message)<br><br>Trajectory segments start from the point, where the vehicle enters the edge, and terminate at the point, where the vehicle reports that the end node was traversed.

Object structure | Unit | Data type | Description
---|---|---|---
**plannedPath** { | | JSON object |  
**trajectory** | | JSON object | The trajectory is to be communicated as a NURBS and is defined in chapter [7.6.6 Implementation of the order message](#766-implementation-of-the-order-message). 
...
actionStatus | | string | Enum {'WAITING', 'INITIALIZING', 'RUNNING', 'PAUSED', 'FINISHED', 'FAILED'}<br><br>See Section [7.13 actionStates](#713-action-states).
...
For additional information see Section [7.12.7 Implementation of the state message](#7127-implementation-of-the-state-message) for the vehicle state.
The update rate for this topic is defined by the integrator.


## 8.2.8 Topic "connection"
...
If an error occurs due to an erroneous order, the AGV should return a meaningful error reference in the field errorReferences (see Section [7.12.7 Implementation of the state message](#7127-implementation-of-the-state-message) of the state topic).
